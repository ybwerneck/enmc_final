# -*- coding: utf-8 -*-
"""
Created on Wed Aug 30 22:04:30 2023
...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 30 21:39:18 2023
...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 30 15:12:19 2023
...
krg = 0.5*(10**(-11)) #permeabilidade efetiva (gás)
...
directory = 'ar'  # Replace with your subfolder path
for idx, time in enumerate(times_of_interest):
    ...
    plt.subplot(1, 2, 1)
    plt.imshow((calculated_matrix[1:-1,1:-1])/0.33, cmap='viridis', origin='lower',vmin=1,vmax=0)
